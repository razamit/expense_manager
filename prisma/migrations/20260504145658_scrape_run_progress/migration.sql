/*
  ...
  - Added the required column `updatedAt` to the `ScrapeRun` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ScrapeRun" ("accountId", "completedAt", "errorMessage", "errorType", "id", "newTxnCount", "startedAt", "status", "txnCount", "updatedAt") SELECT "accountId", "completedAt", "errorMessage", "errorType", "id", "newTxnCount", "startedAt", "status", "txnCount", coalesce("completedAt", "startedAt") FROM "ScrapeRun";
